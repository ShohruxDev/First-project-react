...
const Footer = () => {
    return <div className="flex w-[100vw] bg-black items-center justify-center ">
     ...
     <div className="flex w-[100%] h-[4px] bg-blue-950 mt-[170px]">
...
<div className="flex flex-col  py-[20px] text-white w-[20%]">
 ...
 <p className='w-[90%]'>Antool is a web collection of information on paid or free Design and Development tools</p>
</div>
<div className="flex flex-col  py-[20px] text-white w-[20%]">
 <div className="flex items-center gap-[15px]">
